 ...
 * @author Agarwal
 */
public class KullaniciKayitlari extends javax.swing.JFrame {
    ...
    private void Get_Data() {
        String sql = "select name as 'İsim', user_name as 'K.Adi',password,contact_no as 'Cep No',email_id as 'Email ' from registration";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KullaniciKayitlari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new KullaniciKayitlari().setVisible(true);
            }
        });
    }
