 ...
 * @author Agarwal
 */
public class HastaKayitlari extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
     ...
     */
    public HastaKayitlari() {
        initComponents();
        con= Connect.ConnectDB();
        Get_Data();
    }
private void Get_Data(){
           String sql="select PatientID as 'Hasta ID', PatientName as 'Hasta ismi',FatherName as 'Baba Adi',Address as 'Adres',ContactNo as 'Tel No',Email as 'Email ',Age,Gen as 'Cinsiyet',BG as 'Kan Grubu',Remarks as 'Hastalik' from Patientregistration";
           try{
...
JOptionPane.showMessageDialog(rootPane, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HastaKayitlari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HastaKayitlari().setVisible(true);
            }
        });
    }
