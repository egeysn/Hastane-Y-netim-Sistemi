 ...
 * @author Agarwal
 */
public class ServisKayitlari extends javax.swing.JFrame {
 ...
 private void Get_Data(){
       String sql="select ServiceID as 'Servis ID', ServiceName as 'Servis Adı',ServiceDate as 'Servis Tarihi',PatientRegistration.PatientID as 'Hasta ID',PatientName as 'Hasta Ad,Soyad',ServiceCharges as 'Servis Ücreti' from PatientRegistration,Services where Services.PatientID=PatientRegistration.PatientID order by PatientName";
       try{         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServisKayitlari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServisKayitlari().setVisible(true);
            }
        });
    }
