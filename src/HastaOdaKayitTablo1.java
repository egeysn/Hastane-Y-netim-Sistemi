 ...
 * @author Agarwal
 */
public class HastaOdaKayitTablo1 extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         String sql="Select PatientRegistration.PatientID as 'Hasta ID',PatientRegistration.PatientName as 'Hasta Adi',PatientRegistration.Gen as 'Cinsiyet',PatientRegistration.BG as 'Kan grubu',Disease,AdmitDate as 'Eklenme tarihi',Room.RoomNo as 'Oda no',Doctor.DoctorID as 'DoKtor ID',DoctorName as 'Doktor Adı',AdmitPatient_Room.AP_Remarks as 'Tanılar' from Room,Doctor,PatientRegistration,AdmitPatient_Room where Room.RoomNo=AdmitPatient_Room.RoomNo and Doctor.DoctorID=AdmitPatient_Room.DoctorID and PatientRegistration.PatientID=AdmitPatient_Room.PatientID order by admitdate";
         try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                this.hide();
                HastaOdaEkle frm = new HastaOdaEkle();
                frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HastaOdaKayitTablo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HastaOdaKayitTablo1().setVisible(true);
            }
        });
    }
