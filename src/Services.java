...
PreparedStatement pst=null;
 ...
 private void Get_Data1(){
      try{
        ...
        String sql="select PatientID as 'Hasta ID', PatientName as 'Hasta Ad,Soyad' from Patientregistration order by PatientName";
...
{   
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Servis Bilgileri"));

        jLabel1.setText("Servis Adı");

        jLabel2.setText("Servis Tarihi");

        jLabel3.setText("Hasta ID");

        jLabel4.setText("Hasta Adı,Soyadi");
        ...
        txtGetData.setText("Kayıtları Getir");
    ...
    private void txtSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSaveActionPerformed
        try{
            ...
            if (txtServiceName.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Servis adi giriniz");
                return;
            }
            if (txtServiceDate.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Servis tarihi seçiniz");
                return;
            }
            if (txtPatientID.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Hasta id seçiniz");
                return;
            }
            if (txtServiceCharges.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Servis ücreti seçiniz");
                return;
            }
            ...
            JOptionPane.showMessageDialog(this,"Başarıyla kaydedildi","Kayit",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void txtDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDeleteActionPerformed
        try{
            int P = JOptionPane.showConfirmDialog(null," Silmek istediğinize eminmisiiniz ?","?",JOptionPane.YES_NO_OPTION);
            if (P==0)
            {
                con=Connect.ConnectDB();
                ...
                pst=con.prepareStatement(sql);
                pst.execute();
                JOptionPane.showMessageDialog(this,"Basarıyla silindi");
    ...
    private void txtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUpdateActionPerformed
        try{
            ...
            pst=con.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(this,"Basarıyla güncellendi");
            txtUpdate.setEnabled(false);
        }catch(HeadlessException | SQLException ex){
            JOptionPane.showMessageDialog(this,ex);
        }
    ...
    private void txtGetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtGetDataActionPerformed
        this.hide();
        ServisKayitlari frm= new ServisKayitlari();
        frm.setVisible(true);
